...
class Locationforest():
    ...
    def __init__(self, description, examineText):
        self.description = description #gm_scenarios.forest["description"][random.randint(0, len(gm_scenarios.forest["description"]) -1)] # Flavortext that is printed when entering a new location.
