...
forest = {
    ...
    "startlocationagain": ['After a while of struggling through a shrubbery you finally get into a clearing in the forest, you look around and find out that this is the place that you woke up earlier. You immidiately find out that you have to move on.\n'],
...
town = {
    "intro": 'You wake up with a thundering headache. The nisse\'s are nowhere to be seen. While sorting out your business you realize that you are in the edge of the forest, which is scarser here. You can see rooftops in the distance to the south east...\n',
    ...
    [[
        ...
        [
            ...
            'You\'re standing by a barn next to some fields. The fields look like they\'ve had better days. To the south there are more fields. You see the village to the east.\n',
...
COMBAT_FLAVOR = {
    ...
    'Before you know it ',
    'Suddenly you notice that it get\'s really cold, you see that the puddle of water in front of you freezes solid. ' ,
