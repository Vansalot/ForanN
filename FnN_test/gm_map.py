    ...
    def drawMap(self, gameState):
        ...
        for column in range(len(self.theMap)):
            ...
            if nlxpLine2P2 == False:
                print(nlxpLine2 + '%s%s %s%s' % (extraSpace, '|',boardRow, '|'))
                nlxpLine2P2 = True
                continue
            if filler1 == False:
                print(' Inventory: '.center(spacing) + '    %s%s %s%s' % (extraSpace, '|',boardRow, '|'))
                filler1 = True
                continue
            if filler2 == False:
                print(' Weapon: '.center(spacing) + '    %s%s %s%s' % (extraSpace, '|',boardRow, '|'))
                filler2 = True
                continue
